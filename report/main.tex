...
\include{chapters/funcionalidades}
\include{chapters/arquitectura}
\include{chapters/search}
\include{chapters/agent}
\include{chapters/recommendation}
\include{chapters/ux-ui}
\include{chapters/expansion}
...
\begin{thebibliography}{2}
    ...
    \bibitem{Typer}Typer. (2024). \textit{Typer: Library for building CLI applications}. \url{https://typer.tiangolo.com}

    \bibitem{Rich}Rich. (2024). \textit{Rich: Rich text and beautiful formatting in the terminal}. \url{https://rich.readthedocs.io}

    \bibitem{FastEmbed}FastEmbed. (2024). \textit{FastEmbed: Fast, Lightweight Embedding Model}. \url{https://github.com/qdrant/fastembed}

    \bibitem{NextJS}Next.js. (2024). \textit{Next.js: The React Framework}. \url{https://nextjs.org}
